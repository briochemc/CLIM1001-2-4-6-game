 ...
 */
export async function signedLaunch(launchUrl, { userId, ctx, roles = 'Learner', extra = {}, consumerKey, secret }) {
  const fields = {
    ...
    oauth_version: '1.0',
    ...extra, // e.g. custom_next_url, launch_presentation_return_url
  };
